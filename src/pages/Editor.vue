<template>
    ...
    <div class="row mt-3" v-if="loaded">
        ...
        <div class="col-12 mb-3">
            <expandable-card>
                <template #title>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-currency-dollar me-2" viewBox="0 0 16 16">
                        <path
        ...
        <div class="col-12">
            <expandable-card>
                <template #title>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-octagon-fill me-2 text-danger"
                         viewBox="0 0 16 16">
                        <path
